...
use frontend\views\post\Parsedown;
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9">
					...
					<h2><a href="<?= $model->url;?>"><?= Html::encode($model->title);?></a></h2>				
						<div class="author">
							<div class="comment">
								...
								<span class="glyphicon glyphicon-user" aria-hidden="true">浏览量</span><em><?= Html::encode($model->view);?></em>
			...
			<?php }?>
			<?php if($model->edit>=1) {?>
			<?= HTMLPurifier::process($Parsedowns->text($model->content));?>
			<?php }?>
			</div>
